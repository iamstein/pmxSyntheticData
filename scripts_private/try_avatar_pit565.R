...
DRY_RUN <- FALSE          # TRUE  = practice run on public stand-in data, no
                         #         real data read.
                         # FALSE = use the real dataset at DATA_PATH.

user = Sys.getenv("USER")
gps_prefix = gps_prefix = paste0("/view/", user, "_view/vob/")
modeling_data_filename = file.path(gps_prefix, "CPIT565A1/mas/mas_1/data/output_001/", "mt96714_poppkpd.csv")
DATA_PATH <- modeling_data_filename
